...
import Lock from './icon.png'
    ...
    if(this.props.isloggedIn){
        ...
        <><div className="header">
            <img src={ppLogo} className="headerLogo" alt="Parch + Posey" /><h1 className="customerName">{this.props.username} Customer Portal</h1><button className="logOut" onClick={handeLogout}>Logout</button><section className="waves">
